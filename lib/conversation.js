  ...
  EventProcessors = {
    "conversation.item.created": (event) => {
      ...
      if (newItem.type === "message") {
        ...
        newItem.formatted.tool = { type: "function", name: newItem.name, call_id: newItem.call_id, arguments: "" };
        newItem.status = "in_progress";
    ...
    "response.audio.delta": (event) => {
      ...
      const arrayBuffer = this.isLocal ? RealtimeUtils.floatTo16BitPCM(delta) : RealtimeUtils.base64ToArrayBuffer(delta);
